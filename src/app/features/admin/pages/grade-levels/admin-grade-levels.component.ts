...
const DEFAULT_GRADE_LEVELS: GradeLevelDto[] = [
  { id: '1', name: 'الصف الأول الابتدائي', description: 'المرحلة الابتدائية', sortOrder: 1, isActive: true, createdAt: '2026-01-01T00:00:00Z' },
  { id: '2', name: 'الصف الثاني الابتدائي', description: 'المرحلة الابتدائية', sortOrder: 2, isActive: true, createdAt: '2026-01-01T00:00:00Z' },
  { id: '3', name: 'الصف الثالث الابتدائي', description: 'المرحلة الابتدائية', sortOrder: 3, isActive: true, createdAt: '2026-01-01T00:00:00Z' },
  { id: '4', name: 'الصف الرابع الابتدائي', description: 'المرحلة الابتدائية', sortOrder: 4, isActive: true, createdAt: '2026-01-01T00:00:00Z' },
  { id: '5', name: 'الصف الخامس الابتدائي', description: 'المرحلة الابتدائية', sortOrder: 5, isActive: true, createdAt: '2026-01-01T00:00:00Z' },
  { id: '6', name: 'الصف السادس الابتدائي', description: 'المرحلة الابتدائية', sortOrder: 6, isActive: true, createdAt: '2026-01-01T00:00:00Z' },
  { id: '7', name: 'الصف الأول الإعدادي', description: 'المرحلة الإعدادية', sortOrder: 7, isActive: true, createdAt: '2026-01-01T00:00:00Z' },
  { id: '8', name: 'الصف الثاني الإعدادي', description: 'المرحلة الإعدادية', sortOrder: 8, isActive: true, createdAt: '2026-01-01T00:00:00Z' },
  { id: '9', name: 'الصف الثالث الإعدادي', description: 'المرحلة الإعدادية', sortOrder: 9, isActive: true, createdAt: '2026-01-01T00:00:00Z' },
  { id: '10', name: 'الصف الأول الثانوي', description: 'المرحلة الثانوية', sortOrder: 10, isActive: true, createdAt: '2026-01-01T00:00:00Z' },
  { id: '11', name: 'الصف الثاني الثانوي', description: 'المرحلة الثانوية', sortOrder: 11, isActive: true, createdAt: '2026-01-01T00:00:00Z' },
  { id: '12', name: 'الصف الثالث الثانوي', description: 'المرحلة الثانوية (شهادة الثانوية العامة)', sortOrder: 12, isActive: true, createdAt: '2026-01-01T00:00:00Z' },
];
