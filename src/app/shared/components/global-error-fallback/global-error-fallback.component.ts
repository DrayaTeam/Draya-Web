...
@Component({
  ...
  template: `
    <div class="bg-background flex min-h-screen items-center justify-center px-4 py-12">
      <div
        class="flex w-full max-w-md flex-col items-center justify-center rounded-xl border border-red-500/15 bg-red-500/[0.04] p-12 text-center">
        ...
        <button
          (click)="onRetry()"
          class="bg-primary text-primary-foreground hover:bg-primary/95 rounded-lg px-6 py-2 font-semibold transition active:scale-[0.98]">
