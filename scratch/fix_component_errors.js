...
tsContent = tsContent.replace(/import { DropdownModule } from 'primeng\/dropdown';/g, "import { SelectModule } from 'primeng/select';");
...
tsContent = tsContent.replace(/const subjectId = this\.selectedClassroom\(\)\?\.subjectId \|\| '';/g, "const subjectId = ''; // TODO: get real subjectId if needed");
